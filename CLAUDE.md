...
| 1 | Str beyond the better-known helpers | to plan | |
| 2 | Arr and Collection: the methods nobody imports | to plan | |
| 3 | Support classes with no docs page (and one with partial docs) | to plan | |
| 4 | Querying relationships without `whereHas` | to plan | |
| 5 | Lesser-known query builder features | to plan | |
| 6 | The HTTP client beyond the basics | to plan | |
| 7 | Testing responses like an expert | to plan | |
